...
A node is cacheable if and only if it and its entire sibling chain contain NO substitution-dependent nodes. See [syntax-nodes.md](../components/syntax-nodes.md) for the full cacheability table.
